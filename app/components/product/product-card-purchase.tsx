...
export function ProductCardPurchase({
  ...
  return (
    <div className="space-y-3">
      {hasVariants ? (
        <>
          <div className="space-y-2 rounded-2xl bg-[#fcf8f4] p-3">
      ...
      <div className="flex flex-col gap-2">
        ...
        <Link
          ...
          className="flex w-full items-center justify-center rounded-full border border-[#dccbbc] px-4 py-3 text-xs font-bold uppercase tracking-[0.2em] text-[#4A3728] transition hover:bg-[#f8efe7]"
        >
          Ver detalle
        </Link>
      </div>
